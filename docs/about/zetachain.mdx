---
sidebar_label: What is ZetaChain?
hide_title: true
...
bridges have varying, often centralized trust models that have a track record
...
[here](../developers/cross-chain-messaging/connector.mdx).

### Managed external assets

ZetaChain's network and dApps built on top of ZetaChain can manage assets and
vaults of external connected chains. This allows assets on any chain to be
