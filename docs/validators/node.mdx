...
Please refer to [Technical Requirements](/validators/requirements.mdx) for more
...
ZetaChain configuration files can be downloaded from the [Athens3 Github
...
logs. You can create a Systemd unit file at the following location `/etc/systemd/system/zetacored.service`:
