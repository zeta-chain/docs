...
sidebar_label: Smart contract helpers
id: smart-contract-helpers
---

import CodeBlock from "@theme/CodeBlock";

In this tutorial we use several helpers to common tasks. Here you can find a link to those helpers:

[Swap Helper Lib](https://github.com/zeta-chain/zetachain/tree/main/packages/zevm-example-contracts/contracts/shared/SwapHelperLib.sol)

```solidity title="SwapHelperLib.sol"
...
[Bytes Helper Lib](https://github.com/zeta-chain/zetachain/tree/main/packages/zevm-example-contracts/contracts/shared/BytesHelperLib.sol)

```solidity title="BytesHelperLib.sol"
