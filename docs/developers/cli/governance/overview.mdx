...
- Create a `proposal.json` file. The contents of the proposal file depends on
  ...
  [parameter change proposal](/developers/cli/governance/parameter),
  [software upgrade proposal](/developers/cli/governance/upgrade), etc.
...
Check out the [text proposal](/developers/cli/governance/text) doc to learn more
