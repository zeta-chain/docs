...
([Uniswap V2](https://github.com/zeta-chain/zetachain/blob/main/packages/protocol-contracts/contracts/ZetaTokenConsumerUniV2.strategy.sol),
[Uniswap V3](https://github.com/zeta-chain/zetachain/blob/main/packages/protocol-contracts/contracts/ZetaTokenConsumerUniV3.strategy.sol),
and
