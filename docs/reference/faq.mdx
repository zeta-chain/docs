...
Read more about ZetaChain [here](/about/zetachain.mdx).
...
Read more about the ZETA token [here](/about/zeta.mdx).
...
dApp using ZetaChain's [Connector](/developers/cross-chain-messaging/connector.mdx).
...
handle reverts easily with the [Connector
docs](/developers/cross-chain-messaging/connector.mdx).
...
We will be releasing a full schedule for the launch of our Athens (testnet) and
ZetaChain Mainnet soon. Stay tuned on our Twitter, Discord, and Telegram for
updates. The current Athens Testnet is live, and you can develop dApps with that.
