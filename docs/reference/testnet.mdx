...
- For Metamask, you can use this tutorial: https://support.metamask.io/hc/en-us/articles/4502810252059-How-to-remove-networks
- For Coinbase Wallet, go to Settings > Networks > Custom, and find your current ZetaChain network. At the bottom of this network’s page, press the Delete button.
