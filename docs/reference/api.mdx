...
# Private API/RPC endpoints

If you are a developer we highly recommend signing up for a free private
endpoint through (AllThatNode)[https://www.allthatnode.com/pricing.dsrv], BlockPi[https://blockpi.io/pricing], or one of our other RPC partners. The
