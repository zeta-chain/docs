...
<Alert variant="danger">
  ...
  download the new binaries specified in the upgrade proposal. This would fail if the github api is down. We suggest
  keeping this feature enabled, but preloading and validating any new binaries before the upgrade to minimize risk. If
  you have already preloaded the binaries, none will be downloaded. Read more about [cosmovisor Auto-Download
  here](https://docs.cosmos.network/v0.47/build/tooling/cosmovisor#auto-download).
</Alert>
