[@zetachain/toolkit](/src/pages/developers/frontend/toolkit/index.mdx) / ZetaChainClient
...
> **new ZetaChainClient**(`params`): [`ZetaChainClient`](toolkit/Class.ZetaChainClient.mdx)
...
• **params**: [`ZetaChainClientParams`](toolkit/TypeAlias.ZetaChainClientParams.mdx)

#### Returns

[`ZetaChainClient`](toolkit/Class.ZetaChainClient.mdx)
...
• **this**: [`ZetaChainClient`](toolkit/Class.ZetaChainClient.mdx)
