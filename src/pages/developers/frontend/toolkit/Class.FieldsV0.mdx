[@zetachain/toolkit](/src/pages/developers/frontend/toolkit/index.mdx) / FieldsV0
...
> **new FieldsV0**(`receiver`, `payload`, `revertAddress`): [`FieldsV0`](/src/pages/developers/frontend/toolkit/Class.FieldsV0.mdx)
