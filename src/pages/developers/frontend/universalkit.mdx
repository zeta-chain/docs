...
The Staking Rewards component displays the staked amount, amount of tokens being
unstaked, and the amount of rewards earned. The component also allows users to
