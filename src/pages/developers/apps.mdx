...
description: A universal app is an EVM-compatible smart contract deployed on ZetaChain's universal EVM. These apps can interact seamlessly with multiple blockchains, including Ethereum and Bitcoin.
---
...
<Alert>
  Transferring ERC-20 ZETA is different from other tokens. To transfer ERC-20 ZETA tokens to and from universal apps,
  use the [Connector API](./connector).
</Alert>
