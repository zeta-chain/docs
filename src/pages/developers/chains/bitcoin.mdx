...
| Byte `2` | Operation code in upper nibble (e.g., 0x10 for Call = 0x02 << 4)                                |
| Byte `3` | Flags bitmask. Indicates which fields are set. Common value: 0x07 (receiver + payload + revert) |
...
| ------------------------- | ------ |
| `EncodingFmtABI`          | `0x01` |
| `EncodingFmtCompactShort` | `0x02` |
| `EncodingFmtCompactLong`  | `0x03` |
...
📦 Used when minimizing size matters, or ABI encoding is overkill.
...
To deposit BTC as ZRC-20 BTC to an EOA or a universal contract receiver on
ZetaChain:
