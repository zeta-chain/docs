...
ensures your contract is correctly wired into ZetaChain’s cross-chain messaging
system.
...
This is triggered if the destination contract’s onMessageReceive fails (e.g.,
...
You don’t need to interact with the Universal Router directly. Just encode your
message, call the Gateway, and ZetaChain will handle the rest.

> 🔧 Advanced: If you need more control, for example, to customize how tokens
...
messages. In this step, you’ll establish a bidirectional link between the two
...
⚠️ If you skip this step or set the wrong address/chain ID, messages will be
...
This makes the system fully automated: you don’t need to hold or acquire the
destination chain’s native token to interact with it.
