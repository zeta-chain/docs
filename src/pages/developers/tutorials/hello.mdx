...
description: In this tutorial you will create a simple universal app contract, deploy it on ZetaChain and make a contract call from a connected chain.
---
...
- `contracts/MyContract.sol`: a Solidity universal app contract
...
```solidity filename="contracts/MyContract.sol"
...
`MyContract` is a simple contract that inherits from the [`zContract`
...
task("deploy", "Deploy the contract", main)
  ...
  .addOptionalParam("name", "Contract to deploy", "MyContract");
```
...
faucets](/reference/get-testnet-zeta/#getting-additional-testnet-gas-assets).
...
Learn more about these and other ZetaChain toolkit commands [avaialble in the
template](/developers/template/).
