---
title: First Omnichain Contract
description: In this tutorial you will create a simple omnnichain contract, deploy it on ZetaChain and make a contract call from a connected chain.
hero: true
---
