...
find the ZRC-20 contract address of the destination token in the [ZRC-20 section
of the docs](/developers/tokens/zrc20).
...
parameter. You can find the address of the token in the [ZRC-20 section of the
