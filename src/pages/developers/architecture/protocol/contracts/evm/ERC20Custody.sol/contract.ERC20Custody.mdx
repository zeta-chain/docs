# ERC20Custody
[Git Source](https://github.com/zeta-chain/protocol-contracts/blob/main/docs/src/contracts/evm/ERC20Custody.sol)

**Inherits:**
Initializable, UUPSUpgradeable, [IERC20Custody](/src/pages/developers/architecture/protocol/contracts/evm/interfaces/IERC20Custody.sol/interface.IERC20Custody.mdx), ReentrancyGuardUpgradeable, AccessControlUpgradeable, PausableUpgradeable
