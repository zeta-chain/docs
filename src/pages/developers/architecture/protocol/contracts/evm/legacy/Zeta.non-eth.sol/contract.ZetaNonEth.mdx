# ZetaNonEth
[Git Source](https://github.com/zeta-chain/protocol-contracts/blob/main/docs/src/contracts/evm/legacy/Zeta.non-eth.sol)

**Inherits:**
[ZetaNonEthInterface](/src/pages/developers/architecture/protocol/contracts/evm/legacy/ZetaNonEthInterface.sol/interface.ZetaNonEthInterface.mdx), ERC20Burnable, [ZetaErrors](/src/pages/developers/architecture/protocol/contracts/evm/legacy/ZetaErrors.sol/interface.ZetaErrors.mdx)
