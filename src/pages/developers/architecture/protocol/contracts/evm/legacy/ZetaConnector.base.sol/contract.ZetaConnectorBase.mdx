# ZetaConnectorBase
[Git Source](https://github.com/zeta-chain/protocol-contracts/blob/main/docs/src/contracts/evm/legacy/ZetaConnector.base.sol)

**Inherits:**
[ConnectorErrors](/src/pages/developers/architecture/protocol/contracts/evm/legacy/ConnectorErrors.sol/interface.ConnectorErrors.mdx), Pausable
