# GatewayZEVM
[Git Source](https://github.com/zeta-chain/protocol-contracts/blob/main/docs/src/contracts/zevm/GatewayZEVM.sol)

**Inherits:**
[IGatewayZEVM](/src/pages/developers/architecture/protocol/contracts/zevm/interfaces/IGatewayZEVM.sol/interface.IGatewayZEVM.mdx), Initializable, AccessControlUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, [INotSupportedMethods](/src/pages/developers/architecture/protocol/contracts/Errors.sol/interface.INotSupportedMethods.mdx)
