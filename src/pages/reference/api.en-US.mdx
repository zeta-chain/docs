...
description: "Public and private RPC, API, and WebSocket endpoints for interacting with ZetaChain"
---
...
[Alchemy](https://www.alchemy.com/zetachain), [Blockscout Pro API](https://docs.blockscout.com/devs/pro-api#pro-api-overview), or another RPC provider. The
...
> Live latency benchmarks for these endpoints (p50/p90/p99, 3 regions, updated every 60 s): [OpenChainBench ZetaChain RPC](https://openchainbench.com/benchmarks/zetachain-rpc)
