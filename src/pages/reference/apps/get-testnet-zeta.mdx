...
You can view the addresses on respective chains [here](/reference/network/contracts).
...
- Add ZETA token by pasting the `zetaToken` contract address from the
  [testnet addresses](/reference/network/contracts) page into the input field
