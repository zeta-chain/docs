---
title: RPC / API 端点
description: "用于与 ZetaChain 交互的公共与私有 RPC、API 及 WebSocket 端点"
---
...
如果你是开发者，强烈建议通过 [AllThatNode](https://www.allthatnode.com/zetachain.dsrv)、[BlockPI](https://blockpi.io/zeta)、[InfStones](https://infstones.com/fast-api)、[Blast API](https://blastapi.io/chains/zetachain)、[dRPC](https://drpc.org/chainlist/zeta-chain)、[Alchemy](https://www.alchemy.com/zetachain)、[Blockscout Pro API](https://docs.blockscout.com/devs/pro-api#pro-api-overview) 等 RPC 提供商申请免费的私有端点。相比公共 RPC，私有端点具备更高吞吐、更少限制，体验更稳定。
