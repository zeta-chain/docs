...
Stay tuned on our <a href={globalLinks.twitterLink} target="_blank" className="text-[#00A5C6] dark:text-[#B0FF61]">Twitter</a>
and <a href={globalLinks.discordLink} target="_blank" className="text-[#00A5C6] dark:text-[#B0FF61]">Discord</a> for the latest updates in our protocol.
...
Check out the validator docs [here](/nodes/requirements).
