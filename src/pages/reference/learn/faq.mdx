...
to your dApp using ZetaChain's [Connector](/developers/evm/connector) or build
an [omnichain dapp](/developers/apps/intro) that can manage assets on different
chain from a single contract.

Stay tuned on our <a href={globalLinks.twitterLink} target="_blank"
className="text-[#00A5C6] dark:text-[#B0FF61]">Twitter</a> and <a
href={globalLinks.discordLink} target="_blank" className="text-[#00A5C6]
dark:text-[#B0FF61]">Discord</a> for the latest updates in our protocol.
...
handle reverts easily with the [Connector docs](/developers/evm/connector).
