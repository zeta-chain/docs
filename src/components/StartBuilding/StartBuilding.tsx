...
const StartBuildingItem = ({
  ...
  return (
    <Link
      ...
      to={link}
    >
      <h4 className="text-md font-semibold mb-2 dark:text-white text-grey-400">
        {title}
      </h4>
  ...
  return (
    <div className="bg-grey-100 dark:bg-grey-800 rounded-lg p-6">
      ...
      <p className="dark:text-grey-300 text-grey-500 mb-4">
        Check one of our examples with real code to build your own omnichain
        messaging applications using ZetaChain&apos;s Connector.
      </p>
