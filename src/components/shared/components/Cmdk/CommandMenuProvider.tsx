...
import { createContext, ElementRef, PropsWithChildren, useContext, useEffect, useRef, useState } from "react";

import { CommandInput } from "./Command.utils";

// `CommandMenu` is heavy - code split to reduce app bundle size
const CommandMenu = dynamic(() => import("./CommandMenu").then(({ CommandMenu }) => CommandMenu), {
  loading: () => <p>Loading...</p>,
});
