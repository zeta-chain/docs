...
export const alertVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        default: "text-foreground bg-alternative border-alternative [&>svg]:text-background [&>svg]:bg-foreground",
        destructive:
          "text border-destructive-400 bg-destructive-200 [&>svg]:text-destructive-200 [&>svg]:bg-destructive-600",
        warning: "border-warning-400 bg-warning-200 [&>svg]:text-warning-200 [&>svg]:bg-warning-600",
      },
    },
    defaultVariants: {
      variant: "default",
