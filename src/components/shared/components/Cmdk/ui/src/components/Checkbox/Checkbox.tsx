      ...
      {({ parentCallback, parentSize }) => {
        ...
        return (
          <div className={containerClasses.join(" ")}>
            ...
            <label className={[__styles.label.base, __styles.label[size]].join(" ")} htmlFor={markupId}>
              <span>
                {beforeLabel && (
                  <span className={[__styles.label_before.base, __styles.label_before[size]].join(" ")}>
                    {beforeLabel}
                  </span>
                )}
                {label}
              ...
              {description && (
                <p className={[__styles.description.base, __styles.description[size]].join(" ")}>{description}</p>
              )}
            </label>
          </div>
        );
