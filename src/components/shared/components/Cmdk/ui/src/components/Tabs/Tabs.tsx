...
import { Children, type KeyboardEvent, type PropsWithChildren, type RefObject, useMemo, useState } from "react";
...
const Tabs: React.FC<PropsWithChildren<TabsProps>> & TabsSubComponents = ({
  ...
  return (
    <TabsPrimitive.Root value={activeTab} className={[__styles.base, baseClassNames].join(" ")} ref={refs?.base}>
