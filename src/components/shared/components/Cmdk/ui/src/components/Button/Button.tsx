        ...
        {asChild ? (
          isValidElement(children) ? (
            cloneElement(
              ...
              children.props.children && <span className={"truncate"}>{children.props.children}</span>,
              iconRight && !loading && <div className={cn(IconContainerVariants({ size }))}>{iconRight}</div>
            )
          ) : null
        ) : (
          <>
