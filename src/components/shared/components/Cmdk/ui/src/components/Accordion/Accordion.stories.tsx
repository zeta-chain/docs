...
export const OneItem = (args: AccordionProps) => (
  <Accordion {...args} justified={false}>
    <Accordion.Item
      header={
        <>
          <span className="text-foreground-muted group-hover:text-foreground">Title of the thing</span>
...
export const MultipleItems = (args: AccordionProps) => (
  <Accordion {...args} openBehaviour="multiple">
    <Accordion.Item
      header={<span className="text-foreground-muted group-hover:text-foreground">Title of the thing</span>}
      id={"1"}
    >
      <span className="text-foreground-muted">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur amet labore.
