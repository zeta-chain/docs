...
import { Button, Checkbox, Input, InputNumber, Listbox, Radio, Select, Toggle } from "../../../index";
      ...
      >
        {({ isSubmitting }: any) => (
          ...
          >
            {/* <p>{isSubmitting ? 'submitting' : 'not submitting'}</p> */}
            {/* <div className="border-t border-muted"></div> */}
            <Section header={<label className="text-sm text-foreground col-span-4">Faster checkout</label>}>
              <Toggle
