  ...
  return (
    <div className={cn("min-h-64", "flex items-center justify-center")}>
      <div className="p-10 flex flex-col items-center gap-6 mt-4">
        ...
        <p className="text-lg text-center">Sorry, looks like we&apos;re having some issues with the command menu!</p>
...
export const CommandInput = React.forwardRef<CommandPrimitiveInputElement, CommandPrimitiveInputProps>(
...
export const CommandEmpty = React.forwardRef<CommandPrimitiveEmptyElement, CommandPrimitiveEmptyProps>((props, ref) => (
  <CommandPrimitive.Empty ref={ref} className="py-6 text-center text-sm text-foreground-muted" {...props} />
));
...
export const CommandGroup = React.forwardRef<CommandPrimitiveGroupElement, CommandPrimitiveGroupProps>(
  ({ className, ...props }, ref) => (
...
type CommandPrimitiveSeparatorProps = React.ComponentPropsWithoutRef<typeof CommandPrimitive.Separator>;

export const CommandSeparator = React.forwardRef<CommandPrimitiveSeparatorElement, CommandPrimitiveSeparatorProps>(
  ({ className, ...props }, ref) => (
...
export const CommandShortcut = ({ className, children, onClick, type = "default" }: CommandShortcutProps) => {
  return (
    <button
      onClick={onClick}
      className={cn(
...
export interface TextHighlighterProps extends DetailedHTMLProps<HTMLAttributes<HTMLSpanElement>, HTMLSpanElement> {
  text: string;
  query: string;
}
