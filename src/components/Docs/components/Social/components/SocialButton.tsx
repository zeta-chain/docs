...
export const SocialButton: React.FC<{
  ...
  return (
    <a
      ...
      rel="noreferrer"
      className={clsx(
        "flex w-full p-7 justify-between font-roobert rounded-md items-center text-white hover:text-white hover:scale-[102%] transition-all",
        {
    ...
    >
      <div
        className={clsx("text-xl text-white", {
          "dark:text-black": headerTitle === "Medium",
        })}
      >
        {headerIcon}
      </div>
      ...
      <div
        className={clsx("flex items-center gap-[9.25px] text-xl text-white", {
          "dark:text-black": headerTitle === "Medium",
        })}
      >
        <p>{headerTitle}</p>
