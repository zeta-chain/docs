import { IconDiscord, IconTelegram, IconTwitter } from "~/components/shared";
...
export const SocialButtonsRack = () => {
  return (
    <div className="grid md:grid-cols-2 gap-4 mt-6">
      <SocialButton headerTitle="Discord" headerIcon={<IconDiscord />} link={globalLinks.discordLink} />

      <SocialButton headerTitle="Telegram" headerIcon={<IconTelegram />} link={globalLinks.telegramLink} />

      <SocialButton headerTitle="Twitter" headerIcon={<IconTwitter />} link={globalLinks.twitterLink} />
